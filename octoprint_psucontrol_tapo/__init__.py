...
# Only import octoprint when needed (defer until plugin load)
try:
    import octoprint.plugin
except ImportError:
    # Allow standalone testing without OctoPrint installed
    octoprint = None


# Only define plugin class if octoprint is available
if octoprint:
        ...
        def get_update_information(self):
            return dict(
                psucontrol_shenzhen=dict(
                    ...
                    repo="OctoPrint-PSU-Control-Shenzhen",
                    current=self._plugin_version,

                    # update method: pip w/ dependency links
                    pip="https://github.com/your-github-username/OctoPrint-PSU-Control-Shenzhen/archive/{target_version}.zip"
                )
            )
