...
4. Search for "PSU Control - Tuya" or install from URL:
   ```
   https://github.com/wafflexyzz/OctoPrint-PSUControl-Tuya/archive/main.zip
   ```

### Manual Installation
```bash
pip install https://github.com/your-github-username/OctoPrint-PSUControl-Tuya/archive/main.zip
```
